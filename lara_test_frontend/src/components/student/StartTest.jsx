...
const StartTest = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                ...
                // const response = await axios.post(`${baseURL}/api/test/cumulative-test/getQuestionsByTopicIds`, {
                const response = await axios.post(`${baseURL}/api/test/cumulative-test/getPracticeQuestionsByTopicIds`, {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${baseURL}/api/test/cumulative-test/saveTestResults`, {
